...
Luego, crea dos clases derivadas: Circulo y Rectangulo,
que implementen el método area() de manera diferente.
"""
...
def main():
    ...
    figuras = [Circulo(5), Rectangulo(4, 6), Circulo(3), Rectangulo(10, 2)]
